...
# Output:
# - dist/CleoBot.app
# - dist/CleoBot-<version>.zip
# - dist/CleoBot-<version>.dmg
...
ZIP="$ROOT_DIR/dist/CleoBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/CleoBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/CleoBot-$VERSION.notary.zip"
