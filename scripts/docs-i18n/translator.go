...
- Keep product names in English: CleoBot, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the CleoBot Gateway, use “Gateway网关”.
