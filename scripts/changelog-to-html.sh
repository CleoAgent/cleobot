...
if [[ -z "$version_content" ]]; then
  echo "<h2>CleoBot $VERSION</h2>"
  echo "<p>Latest CleoBot update.</p>"
  echo "<p><a href=\"https://github.com/cleobot/openclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
