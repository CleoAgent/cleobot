...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: CleoBotLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: CleoBotLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: CleoBotLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
