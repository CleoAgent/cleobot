...
final class ScreenController {
    ...
    /// Callback invoked when an cleobot:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = CleoBotKitResources.bundle
...
/// Handles navigation policy to intercept cleobot:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept cleobot:// deep links.
        if url.scheme?.lowercased() == "cleobot" {
