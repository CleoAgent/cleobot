...
@MainActor
public struct CleoBotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: CleoBotChatViewModel,
    ...
    private var visibleMessages: [CleoBotChatMessage] {
        let base: [CleoBotChatMessage]
    ...
    private func mergeToolResults(in messages: [CleoBotChatMessage]) -> [CleoBotChatMessage] {
    ...
    private func isToolResultMessage(_ message: CleoBotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: CleoBotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: CleoBotChatMessage) -> String {
