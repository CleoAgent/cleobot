...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.cleobot", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.cleobot", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: CleoBotProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
