...
public enum CleoBotCanvasA2UICommand: String, Codable, Sendable {
...
public struct CleoBotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct CleoBotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
