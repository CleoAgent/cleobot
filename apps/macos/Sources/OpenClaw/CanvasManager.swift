...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.cleobot", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("CleoBot/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__cleobot__/a2ui/").absoluteString + "?platform=macos"
    }
