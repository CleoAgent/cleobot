...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/cleobot/cleobot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/cleobot/cleobot")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://cleobot.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "CleoBotBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "CleoBotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "CleoBotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CleoBotGitCommit") as? String) ??
            "unknown"
    }
