...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.cleobot", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return CleoBotConfigFile.defaultWorkspaceURL() }
