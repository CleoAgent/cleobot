...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.cleobot", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.cleobot", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [CleoBotChatMessage] = messages.compactMap { item in
