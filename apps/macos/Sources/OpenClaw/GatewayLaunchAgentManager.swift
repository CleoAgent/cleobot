...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.cleobot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".cleobot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.cleobotCommand(
            subcommand: "gateway",
