...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = CleoBotConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = CleoBotConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = CleoBotConfigFile.loadDict()
            ...
            CleoBotConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/cleobot"
        state.remoteCliPath = ""
        return state
    }
}
