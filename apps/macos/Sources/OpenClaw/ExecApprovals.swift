...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.cleobot", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        CleoBotPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        CleoBotPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
