...
enum UIStrings {
    static let welcomeTitle = "Welcome to CleoBot"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: CleoBotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: CleoBotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g cleobot@\(version)"
    }
