...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .cleobotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? CleoBotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? CleoBotPaths.stateDirURL.path
...
extension Notification.Name {
    static let cleobotSelectSettingsTab = Notification.Name("cleobotSelectSettingsTab")
}
