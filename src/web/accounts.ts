...
function listConfiguredAccountIds(cfg: CleoBotConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: CleoBotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CleoBotConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: CleoBotConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: CleoBotConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: CleoBotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CleoBotConfig): ResolvedWhatsAppAccount[] {
