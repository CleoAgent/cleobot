...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CleoBotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CleoBotConfig; env: NodeJS.ProcessEnv }): {
  cfg: CleoBotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
