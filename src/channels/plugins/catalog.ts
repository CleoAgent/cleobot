...
import type { CleoBotPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverCleoBotPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, CleoBotPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["CLEOBOT_PLUGIN_CATALOG_PATHS", "CLEOBOT_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<CleoBotPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: CleoBotPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverCleoBotPlugins({ workspaceDir: options.workspaceDir });
