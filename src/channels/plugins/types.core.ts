...
export type ChannelAgentToolFactory = (params: { cfg?: CleoBotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: CleoBotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: CleoBotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: CleoBotConfig }) => boolean;
  supportsCards?: (params: { cfg: CleoBotConfig }) => boolean;
