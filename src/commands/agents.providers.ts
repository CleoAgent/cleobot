...
function resolveDefaultAccountId(cfg: CleoBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CleoBotConfig): boolean {
...
export function summarizeBindings(cfg: CleoBotConfig, bindings: AgentBinding[]): string[] {
