...
export async function updateConfig(
  mutator: (cfg: CleoBotConfig) => CleoBotConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: CleoBotConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: CleoBotConfig): Set<string> {
