...
function resolveConfiguredModelRaw(cfg: CleoBotConfig): string {
...
function resolveConfiguredModelKeys(cfg: CleoBotConfig): string[] {
...
export function applyPrimaryModel(cfg: CleoBotConfig, model: string): CleoBotConfig {
...
export function applyModelAllowlist(cfg: CleoBotConfig, models: string[]): CleoBotConfig {
  const defaults = cfg.agents?.defaults;
