...
function resolveMode(cfg: CleoBotConfig): "local" | "remote" {
...
export async function doctorCommand(
  ...
  intro("CleoBot doctor");

  const root = await resolveCleoBotPackageRoot({
  ...
  let cfg: CleoBotConfig = configResult.cfg;
