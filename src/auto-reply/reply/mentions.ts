...
function resolveMentionPatterns(cfg: CleoBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: CleoBotConfig | undefined, agentId?: string): RegExp[] {
