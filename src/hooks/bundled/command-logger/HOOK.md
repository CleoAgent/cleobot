...
2. **Appends to log file** - Writes a JSON line to `~/.cleobot/logs/commands.log`
...
1. **Manual rotation**:
   ...
   ```bash
   mv ~/.cleobot/logs/commands.log ~/.cleobot/logs/commands.log.old
   ```
