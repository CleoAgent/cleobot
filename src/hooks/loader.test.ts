...
describe("loader", () => {
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.CLEOBOT_BUNDLED_HOOKS_DIR;
    process.env.CLEOBOT_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      ...
      process.env.CLEOBOT_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
