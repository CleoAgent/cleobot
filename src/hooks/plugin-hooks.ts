...
import type { CleoBotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: CleoBotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: CleoBotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
