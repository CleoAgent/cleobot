...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: CleoBotConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: CleoBotConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: CleoBotConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: CleoBotConfig): void {
