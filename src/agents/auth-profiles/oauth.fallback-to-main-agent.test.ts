...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveCleoBotAgentDir() returns mainAgentDir
    process.env.CLEOBOT_STATE_DIR = tmpDir;
    process.env.CLEOBOT_AGENT_DIR = mainAgentDir;
