...
import { createCleoBotCodingTools } from "./pi-tools.js";
...
describe("Agent-specific tool filtering", () => {
  it("should apply global tool policy when no agent-specific policy exists", () => {
    ...
    const tools = createCleoBotCodingTools({
      config: cfg,
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createCleoBotCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createCleoBotCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createCleoBotCodingTools({
      config: cfg,
    ...
    const defaultTools = createCleoBotCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createCleoBotCodingTools({
      config: cfg,
    ...
    const bobTools = createCleoBotCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createCleoBotCodingTools({
      config: cfg,
