...
function resolveAvatarSource(cfg: CleoBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: CleoBotConfig, agentId: string): AgentAvatarResolution {
