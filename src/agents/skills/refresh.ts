...
function resolveWatchPaths(workspaceDir: string, config?: CleoBotConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: CleoBotConfig }) {
