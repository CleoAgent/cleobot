...
export function listBindings(cfg: CleoBotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: CleoBotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: CleoBotConfig) {
