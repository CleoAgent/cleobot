...
function resolveAnthropicDefaultAuthMode(cfg: CleoBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: CleoBotConfig): CleoBotConfig {
...
export function applyTalkApiKey(config: CleoBotConfig): CleoBotConfig {
...
export function applyModelDefaults(cfg: CleoBotConfig): CleoBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: CleoBotConfig): CleoBotConfig {
...
export function applyLoggingDefaults(cfg: CleoBotConfig): CleoBotConfig {
...
export function applyContextPruningDefaults(cfg: CleoBotConfig): CleoBotConfig {
...
export function applyCompactionDefaults(cfg: CleoBotConfig): CleoBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
