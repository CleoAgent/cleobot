import type { CleoBotConfig } from "./config.js";
...
function isTelegramConfigured(cfg: CleoBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: CleoBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: CleoBotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: CleoBotConfig): boolean {
...
function isIMessageConfigured(cfg: CleoBotConfig): boolean {
...
function isWhatsAppConfigured(cfg: CleoBotConfig): boolean {
...
function isGenericChannelConfigured(cfg: CleoBotConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: CleoBotConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: CleoBotConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: CleoBotConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: CleoBotConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: CleoBotConfig, pluginId: string): CleoBotConfig {
...
function enablePluginEntry(cfg: CleoBotConfig, pluginId: string): CleoBotConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
