...
export function listSlackAccountIds(cfg: CleoBotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: CleoBotConfig): string {
...
function mergeSlackAccountConfig(cfg: CleoBotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: CleoBotConfig): ResolvedSlackAccount[] {
