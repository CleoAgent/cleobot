...
import { ensureCleoBotCliOnPath } from "../infra/path-env.js";
...
const execHostEnforced = process.env.CLEOBOT_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed =
  process.env.CLEOBOT_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
...
function ensureNodePathEnv(): string {
  ensureCleoBotCliOnPath({ pathEnv: process.env.PATH ?? "" });
