...
export function listSignalAccountIds(cfg: CleoBotConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: CleoBotConfig): string {
...
function mergeSignalAccountConfig(cfg: CleoBotConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: CleoBotConfig): ResolvedSignalAccount[] {
