...
import type { CleoBotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: CleoBotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: CleoBotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: CleoBotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: CleoBotConfig) => void;
  log: {
