...
import { type CleoBotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: CleoBotConfig): string[] {
...
export function listAgentsForGateway(cfg: CleoBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: CleoBotConfig): string {
...
function resolveSessionStoreAgentId(cfg: CleoBotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: CleoBotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: CleoBotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: CleoBotConfig): GatewaySessionsDefaults {
