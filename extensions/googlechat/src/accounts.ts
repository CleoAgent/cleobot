...
export function listGoogleChatAccountIds(cfg: CleoBotConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: CleoBotConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: CleoBotConfig): ResolvedGoogleChatAccount[] {
