...
export function listZalouserAccountIds(cfg: CleoBotConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: CleoBotConfig): string {
...
function mergeZalouserAccountConfig(cfg: CleoBotConfig, accountId: string): ZalouserAccountConfig {
