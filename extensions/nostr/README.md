...
Nostr DM channel plugin for CleoBot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to CleoBot. It enables your bot to:
