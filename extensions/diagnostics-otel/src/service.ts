...
import type { DiagnosticEventPayload, CleoBotPluginService } from "openclaw/plugin-sdk";
...
export function createDiagnosticsOtelService(): CleoBotPluginService {
  ...
  } satisfies CleoBotPluginService;
}
