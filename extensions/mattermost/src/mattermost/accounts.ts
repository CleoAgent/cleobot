...
export function listMattermostAccountIds(cfg: CleoBotConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: CleoBotConfig): string {
...
export function listEnabledMattermostAccounts(cfg: CleoBotConfig): ResolvedMattermostAccount[] {
