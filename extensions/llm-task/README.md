...
`openclaw.invoke --each`) without adding new CleoBot code per workflow.
...
This extension depends on CleoBot internal modules (the embedded agent runner).
It is intended to ship as a **bundled** CleoBot extension (like `lobster`) and
