...
// NOTE: This extension is intended to be bundled with CleoBot.
// When running from source (tests/dev), CleoBot internals live under src/.
...
export function createLlmTaskTool(api: CleoBotPluginApi) {
  return {
    name: "llm-task",
    description:
