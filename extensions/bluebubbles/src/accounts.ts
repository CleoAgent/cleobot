...
export function listBlueBubblesAccountIds(cfg: CleoBotConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: CleoBotConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: CleoBotConfig): ResolvedBlueBubblesAccount[] {
