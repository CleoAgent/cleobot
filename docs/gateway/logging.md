...
- Default rolling log file is under `/tmp/openclaw/` (one file per day): `cleobot-YYYY-MM-DD.log`
...
`cleobot gateway` supports a per-gateway style switch:
