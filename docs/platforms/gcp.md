---
summary: "Run CleoBot Gateway 24/7 on a GCP Compute Engine VM (Docker) with durable state"
read_when:
  - You want CleoBot running 24/7 on GCP
  - You want a production-grade, always-on Gateway on your own VM
  - You want full control over persistence, binaries, and restart behavior
title: "GCP"
---

# CleoBot on GCP Compute Engine (Docker, Production VPS Guide)

## Goal

Run a persistent CleoBot Gateway on a GCP Compute Engine VM using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want "CleoBot 24/7 for ~$5-12/mo", this is a reliable setup on Google Cloud.
...
- Start the CleoBot Gateway in Docker
...
```bash
gcloud projects create my-cleobot-project --name="CleoBot Gateway"
...
## 6) Clone the CleoBot repository
...
CleoBot runs in Docker, but Docker is not the source of truth.
