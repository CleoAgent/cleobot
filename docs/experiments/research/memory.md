...
read_when:
  ...
  - Deciding: standalone CLI vs deep CleoBot integration
...
Recommendation: **deep integration in CleoBot**, but keep a separable core library.

### Why integrate into CleoBot?

- CleoBot already knows:
