...
When a site requires login, **sign in manually** in the **host** browser profile (the cleobot browser).
...
CleoBot controls a **dedicated Chrome profile** (named `openclaw`, orange‑tinted UI). This is separate from your daily browser profile.
