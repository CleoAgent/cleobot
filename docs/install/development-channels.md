...
CleoBot ships three update channels:
...
When you **explicitly** switch channels with `--channel`, CleoBot also aligns
the install method:
...
When you switch channels with `cleobot update`, CleoBot also syncs plugin sources:
