...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、安全加固的 CleoBot 安装
title: Ansible
x-i18n:
...
将 CleoBot 部署到生产服务器的推荐方式是使用 **[cleobot-ansible](https://github.com/openclaw/cleobot-ansible)** — 一个采用安全优先架构的自动化安装工具。
...
> **📦 完整指南：[github.com/openclaw/cleobot-ansible](https://github.com/openclaw/cleobot-ansible)**
>
> cleobot-ansible 仓库是 Ansible 部署的权威来源。本页面仅为简要概览。
...
# 或直接运行（之后手动执行 /tmp/cleobot-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 CleoBot

Ansible 安装程序将 CleoBot 设置为手动更新。标准更新流程详见 [更新](/install/updating)。
...
- [安全架构](https://github.com/openclaw/cleobot-ansible/blob/main/docs/security.md)
- [技术细节](https://github.com/openclaw/cleobot-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/openclaw/cleobot-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [cleobot-ansible](https://github.com/openclaw/cleobot-ansible) — 完整部署指南
