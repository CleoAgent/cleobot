...
read_when:
  ...
  - 查找配置示例
  - 首次设置 CleoBot
summary: 常见 CleoBot 设置的符合 Schema 的配置示例
title: 配置示例
x-i18n:
...
```json5
{
  agent: { workspace: "~/.cleobot/workspace" },
  channels: { whatsapp: { allowFrom: ["+15555550123"] } },
}
```

保存到 `~/.cleobot/openclaw.json`，即可从该号码私信机器人。
...
```json5
{
  ...
  session: {
    ...
    store: "~/.cleobot/agents/default/sessions/sessions.json",
