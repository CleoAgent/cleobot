...
- Install via CLI: `cleobot plugins install @openclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `cleobot plugins install ./extensions/zalo`
   - From npm (if published): `cleobot plugins install @openclaw/zalo`
...
- Approve via:
  - `cleobot pairing list zalo`
  - `cleobot pairing approve zalo <CODE>`
...
- Example: `cleobot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `cleobot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `cleobot logs --follow`
