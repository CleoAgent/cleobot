...
read_when:
  - Setting up Twitch chat integration for CleoBot
title: "Twitch"
---

# Twitch (plugin)

Twitch chat support via IRC connection. CleoBot connects as a Twitch user (bot account) to receive and send messages in channels.
...
4. Configure the token:
   - Env: `CLEOBOT_TWITCH_ACCESS_TOKEN=...` (default account only)
...
```json5
{
  channels: {
    twitch: {
      ...
      accessToken: "oauth:abc123...", // OAuth Access Token (or use CLEOBOT_TWITCH_ACCESS_TOKEN env var)
