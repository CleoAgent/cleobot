---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with CleoBot"
read_when:
  - You want Xiaomi MiMo models in CleoBot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). CleoBot uses
