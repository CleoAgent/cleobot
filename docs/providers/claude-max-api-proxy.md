...
You can point CleoBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or CleoBot
...
- [Anthropic provider](/providers/anthropic) - Native CleoBot integration with Claude setup-token or API keys
