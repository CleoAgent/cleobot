---
summary: "Use Synthetic's Anthropic-compatible API in CleoBot"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. CleoBot registers it as the
...
Note: CleoBot's Anthropic client appends `/v1` to the base URL, so use
