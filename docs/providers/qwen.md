---
summary: "Use Qwen OAuth (free tier) in CleoBot"
read_when:
  - You want to use Qwen with CleoBot
...
If you already logged in with the Qwen Code CLI, CleoBot will sync credentials
