---
summary: "Frequently asked questions about CleoBot setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up CleoBot?](#whats-the-recommended-way-to-install-and-set-up-openclaw)
...
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  ...
  - [Windows install says git not found or cleobot not recognized](#windows-install-says-git-not-found-or-cleobot-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install CleoBot on Linux?](#how-do-i-install-cleobot-on-linux)
  - [How do I install CleoBot on a VPS?](#how-do-i-install-cleobot-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask CleoBot to update itself?](#can-i-ask-cleobot-to-update-itself)
  ...
  - [If I buy a Mac mini to run CleoBot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-cleobot-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different CleoBot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-cleobot-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run CleoBot on a dedicated machine?](#how-important-is-it-to-run-cleobot-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run CleoBot in a VM and what are the requirements](#can-i-run-cleobot-in-a-vm-and-what-are-the-requirements)
- [What is CleoBot?](#what-is-openclaw)
  - [What is CleoBot, in one paragraph?](#what-is-cleobot-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for CleoBot](#what-are-the-top-five-everyday-use-cases-for-openclaw)
  - [Can CleoBot help with lead gen outreach ads and blogs for a SaaS](#can-cleobot-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can CleoBot run tasks on a schedule or continuously in the background?](#can-cleobot-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with CleoBot saved locally?](#is-all-data-used-with-cleobot-saved-locally)
  - [Where does CleoBot store its data?](#where-does-cleobot-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall CleoBot?](#how-do-i-completely-uninstall-openclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the CleoBot browser run headless?](#can-the-cleobot-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two CleoBot instances talk to each other (local + VPS)?](#can-two-cleobot-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does CleoBot load environment variables?](#how-does-cleobot-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of CleoBot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-cleobot-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset CleoBot but keep it installed?](#how-do-i-completely-reset-cleobot-but-keep-it-installed)
  ...
  - [Why doesn’t CleoBot reply in a group?](#why-doesnt-cleobot-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do CleoBot, Flawd, and Krill use for models?](#what-do-cleobot-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `cleobot gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-cleobot-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `cleobot gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-cleobot-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run CleoBot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-cleobot-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart CleoBot?](#i-closed-my-terminal-on-windows-how-do-i-restart-openclaw)
  ...
  - [ELI5: `cleobot gateway restart` vs `cleobot gateway`](#eli5-cleobot-gateway-restart-vs-cleobot-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose CleoBot to inbound DMs?](#is-it-safe-to-expose-cleobot-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/openclaw/cleobot-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ```bash
   cleobot health --json
   cleobot health --verbose   # shows the target URL + config path on errors
   ```
...
This installs CleoBot **from a git checkout**, so the agent can read the code + docs and
...
- `cleobot status`: quick snapshot of gateway/agent health + basic config.
- `cleobot models status`: checks provider auth + model availability.
- `cleobot doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `cleobot status --all`, `cleobot logs --follow`,
`cleobot gateway status`, `cleobot health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up CleoBot
...
If you don’t have a global install yet, run it via `pnpm cleobot onboard`.
...
- If it asks for auth, run `cleobot dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `CLEOBOT_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `cleobot gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `cleobot gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `cleobot dashboard`.
...
1. Install CleoBot on the new machine.
2. Copy `$CLEOBOT_STATE_DIR` (default: `~/.cleobot`) from the old machine.
3. Copy your workspace (default: `~/.cleobot/workspace`).
4. Run `cleobot doctor` and restart the Gateway service.
...
under `~/.cleobot/` (for example `~/.cleobot/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-cleobot-store-its-data),
...
### Windows install says git not found or cleobot not recognized
...
**2) cleobot is not recognized after install**
...
### How do I install CleoBot on Linux
...
### How do I install CleoBot on a VPS
...
### Can I ask CleoBot to update itself
...
`cleobot onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run CleoBot with **API keys** (Anthropic/OpenAI/others) or with
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `cleobot models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `cleobot models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. CleoBot no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so CleoBot can keep replying while a provider is rate‑limited.
...
CleoBot supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. CleoBot fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
1. Enable the plugin: `cleobot plugins enable google-gemini-cli-auth`
2. Login: `cleobot models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. CleoBot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. CleoBot runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. CleoBot’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run CleoBot can I connect it to my MacBook Pro
...
- Use `cleobot nodes status` / `cleobot nodes list` to see it.
...
- DM your bot, then run `cleobot logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different CleoBot instances
...
If you run CleoBot via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the CleoBot code install. Your state
(`~/.cleobot`) and workspace (`~/.cleobot/workspace`) stay untouched.
...
**CleoBot-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run CleoBot on a dedicated machine
...
CleoBot is lightweight. For a basic Gateway + one chat channel:
...
### Can I run CleoBot in a VM and what are the requirements
...
### What is CleoBot in one paragraph

CleoBot is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

CleoBot is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for CleoBot
...
### Can CleoBot help with lead gen outreach ads and blogs for a SaaS
...
CleoBot draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

CleoBot is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use CleoBot when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.cleobot/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.cleobot/openclaw.json`). Precedence is `<workspace>/skills` > `~/.cleobot/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.cleobot/openclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.cleobot/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which CleoBot treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `CLEOBOT_SKIP_CRON` is not set.
...
### Can CleoBot run tasks on a schedule or continuously in the background
...
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-cleobot-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. CleoBot can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.cleobot/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
...
For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (CleoBot only needs stdio). See [iMessage](/channels/imessage).
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured CleoBot workspace); CleoBot treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.cleobot/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `CLEOBOT_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `CLEOBOT_DOCKER_APT_PACKAGES`.
...
CleoBot memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

CleoBot also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, CleoBot auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, CleoBot
prefers `local`.
...
### Is all data used with CleoBot saved locally

No - **CleoBot’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.cleobot` + your workspace directory).
...
### Where does CleoBot store its data

Everything lives under `$CLEOBOT_STATE_DIR` (default: `~/.cleobot`):

| Path                                                            | Purpose                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------ |
| `$CLEOBOT_STATE_DIR/openclaw.json`                             | Main config (JSON5)                                          |
| `$CLEOBOT_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$CLEOBOT_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$CLEOBOT_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$CLEOBOT_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$CLEOBOT_STATE_DIR/agents/`                                   | Per‑agent state (agentDir + sessions)                        |
| `$CLEOBOT_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$CLEOBOT_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single‑agent path: `~/.cleobot/agent/*` (migrated by `cleobot doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.cleobot/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.cleobot`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.cleobot`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.cleobot/skills`).

Default workspace is `~/.cleobot/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.cleobot/workspace" } },
}
```
...
Do **not** commit anything under `~/.cleobot` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall CleoBot
...
`workspace` to the repo root. The CleoBot repo is just source code; keep the
...
CleoBot reads an optional **JSON5** config from `$CLEOBOT_CONFIG_PATH` (default: `~/.cleobot/openclaw.json`):

```
$CLEOBOT_CONFIG_PATH
```

If the file is missing, it uses safe‑ish defaults (including a default workspace of `~/.cleobot/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `CLEOBOT_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `cleobot doctor --generate-gateway-token`.
...
key. **Recommended:** run `cleobot configure --section web` to store it in
...
- Daemons read env vars from `~/.cleobot/.env` (or the service environment).
...
### Can the CleoBot browser run headless
...
5. Approve the node on the Gateway:
   ```bash
   cleobot nodes pending
   cleobot nodes approve <requestId>
   ```
...
- Gateway is running: `cleobot gateway status`
- Gateway health: `cleobot status`
- Channel health: `cleobot channels status`
...
### Can two CleoBot instances talk to each other local VPS
...
`cleobot agent --message ... --deliver`, targeting a chat where the other bot
...
- Restore from backup (git or a copied `~/.cleobot/openclaw.json`).
- If you have no backup, re-run `cleobot doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `cleobot config set` for small changes.
- Use `cleobot configure` for interactive edits.
...
### How does CleoBot load environment variables

CleoBot reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.cleobot/.env` (aka `$CLEOBOT_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.cleobot/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`CLEOBOT_LOAD_SHELL_ENV=1`, `CLEOBOT_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`cleobot models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means CleoBot won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.cleobot/.env`:
   ```
...
### Is there a way to make a team of CleoBot instances one CEO and many agents
...
### How do I completely reset CleoBot but keep it installed
...
- If you used profiles (`--profile` / `CLEOBOT_PROFILE`), reset each state dir (defaults are `~/.cleobot-<profile>`).
- Dev reset: `cleobot gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), CleoBot skips the heartbeat run to save API calls.
...
No. CleoBot runs on **your own account**, so if you’re in the group, CleoBot can see it.
...
### Why doesnt CleoBot reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.cleobot/agents/<agentId>/sessions/`.
...
- Use `cleobot doctor` to spot stray workspaces and profile mismatches.
...
CleoBot’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, CleoBot currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `cleobot models set ...` (updates just model config)
- `cleobot configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.cleobot/openclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `cleobot doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do CleoBot, Flawd, and Krill use for models

- **CleoBot + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-5`) - see [Anthropic](/providers/anthropic).
...
Yes. CleoBot ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
- Run `cleobot agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so CleoBot can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.cleobot/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.cleobot/agent/*` (migrated by `cleobot doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.cleobot/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `cleobot models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `cleobot models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `cleobot models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.cleobot/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    cleobot models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), CleoBot will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: CleoBot now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
CleoBot uses provider‑prefixed IDs like:
...
CleoBot may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `cleobot models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
```
--port > CLEOBOT_GATEWAY_PORT > gateway.port > default 18789
```

### Why does cleobot gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `cleobot gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does cleobot gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `CLEOBOT_STATE_DIR` mismatch).
...
CleoBot enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `cleobot gateway --port <port>`.

### How do I run CleoBot in remote mode client connects to a Gateway elsewhere
...
- `cleobot gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `cleobot dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `cleobot doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `CLEOBOT_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `cleobot status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `CLEOBOT_CONFIG_PATH` (per‑instance config)
- `CLEOBOT_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `cleobot --profile <name> …` per instance (auto-creates `~/.cleobot-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `cleobot --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.openclaw.*`, `cleobot-gateway-<profile>.service`, `CleoBot Gateway (<profile>)`).
...
```
/tmp/openclaw/cleobot-YYYY-MM-DD.log
```
...
- macOS: `$CLEOBOT_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.cleobot/logs/...`; profiles use `~/.cleobot-<profile>/logs/...`)
- Linux: `journalctl --user -u cleobot-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "CleoBot Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `cleobot gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart CleoBot
...
1. Is the Gateway running? `cleobot gateway status`
2. Is the Gateway healthy? `cleobot status`
3. Does the UI have the right token? `cleobot dashboard`
...
### ELI5 cleobot gateway restart vs cleobot gateway

- `cleobot gateway restart`: restarts the **background service** (launchd/systemd).
- `cleobot gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `cleobot gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [CleoBot assistant setup](/start/openclaw) and [Agent send](/tools/agent-send).
...
### Is it safe to expose CleoBot to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `cleobot pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `cleobot pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `cleobot doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. CleoBot only replies to chats it receives or to explicit sends you trigger.
...
CleoBot blocks **cross‑provider** messaging by default. If a tool call is bound
