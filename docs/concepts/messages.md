...
This page ties together how CleoBot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. CleoBot keeps a
...
CleoBot separates the **prompt body** from the **command body**:
...
CleoBot can expose or hide model reasoning:
