...
CleoBot has two separate “streaming” layers:
...
When block streaming is enabled, CleoBot can **merge consecutive block chunks**
...
When draft streaming is active, CleoBot disables block streaming for that reply to avoid double-streaming.
