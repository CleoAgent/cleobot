...
CleoBot treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

CleoBot “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, CleoBot can see that group and respond there.
...
Translation: allowlisted senders can trigger CleoBot by mentioning it.
